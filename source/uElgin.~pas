...
function Elgin_DataHoraSoftwareBasico(DataSW, HoraSW: PChar ): Integer;stdcall; External 'Elgin.DLL'; 
...
begin
  ...
  begin
    ...
    aMensagem := 'Erro Nº '+inttostr(iCodErro)+chr(13)+chr(10)+strErroMsg;
  end;
  result:= iRetorno = 1;
end;
